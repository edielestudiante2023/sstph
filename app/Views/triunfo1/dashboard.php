...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-toggler">
        ...
        <ul class="navbar-nav d-flex justify-content-center align-items-center">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://lookerstudio.google.com/reporting/6bf28742-1f27-4fc9-935c-0a257f5174e5" target="blank">Indicadores SST</a>
          </li>
          <li class="nav-item">
        ...
        <a class="navbar-brand" href="https://cycloidtalent.com/index.php/sg-sst-propiedad-horizontal" target="_blank">
          <img src="imagenes/TRIUNFO1.png" width="100" alt="Logo Cliente">
        </a>
      </div>
    </div>
  </nav>
  ...
  <section>
    <div class="hero-inferior">
      <a href="https://lookerstudio.google.com/reporting/6bf28742-1f27-4fc9-935c-0a257f5174e5" target="_blank">
      ...
      <table class="table caption-top table-striped table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="#" target="_blank"><i class="bi bi-file-earmark-excel-fill"> </i></a></i><br>Asignación de Funciones <br>

              <a href="#" target="_blank"><i class="bi bi-file-earmark-bar-graph-fill"></i></a></i><br>Procedimiento
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="#" target="_blank"><i class="bi bi-file-earmark-arrow-down-fill"> </i></a></i><br>Programa de Inducción
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="#" target="_blank"><i class="bi bi-file-earmark-bar-graph-fill"></i></a></i><br>Manual <br>
